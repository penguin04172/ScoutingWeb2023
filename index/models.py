...
class MatchData(models.Model):
    ...
    scouter = models.CharField(max_length=30, default="", null=True)
    robot = models.IntegerField(default=0)
    start = models.IntegerField(default=0)
    auto_grid = models.TextField(default="", null=True)
    tele_grid = models.TextField(default="", null=True)
    ...
    timer_cycle = models.TextField(default="", null=True)
    tele_trans = models.IntegerField(default=0)
    tele_fed = models.BooleanField(default=False)
    tele_defender = models.CharField(max_length=15, default="", null=True)
    ...
    timer_dock = models.TextField(default="", null=True)
    end_dock = models.IntegerField(default=0)
    other_link = models.TextField(default="", null=True)
    other_immobolity = models.BooleanField(default=False)
    other_tippy = models.BooleanField(default=False)
    other_comment = models.TextField(default="", null=True)
