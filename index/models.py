...
class MatchData(models.Model):
    ...
    scouter = models.CharField(max_length=30, default="", null=True, blank=True)
    robot = models.IntegerField(default=0)
    start = models.IntegerField(default=0)
    auto_grid = models.TextField(default="", null=True, blank=True)
    tele_grid = models.TextField(default="", null=True, blank=True)
    ...
    timer_cycle = models.TextField(default="", null=True, blank=True)
    tele_trans = models.IntegerField(default=0)
    tele_fed = models.BooleanField(default=False)
    tele_defender = models.CharField(max_length=15, default="", null=True, blank=True)
    ...
    tele_pick_dn = models.IntegerField(default=0)
    tele_pick_db = models.IntegerField(default=0)
    tele_fail = models.IntegerField(default=0)
    timer_dock = models.TextField(default="", null=True, blank=True)
    end_dock = models.IntegerField(default=0)
    other_link = models.TextField(default="", null=True, blank=True)
    other_immobolity = models.BooleanField(default=False)
    other_tippy = models.BooleanField(default=False)
    other_comment = models.TextField(default="", null=True, blank=True)
    ...
    team_data = models.ForeignKey(Team, on_delete=models.SET_NULL, null=True, blank=True, default=None, related_name='scores')
    ...
    def pick_as_list(self):
        return [self.tele_pick_fn, self.tele_pick_fb, self.tele_pick_sn, self.tele_pick_sb, self.tele_pick_dn, self.tele_pick_db]
